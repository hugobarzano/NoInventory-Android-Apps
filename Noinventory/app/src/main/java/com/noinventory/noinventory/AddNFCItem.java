...
public class AddNFCItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_nfcitem);

        mensaje = (TextView) findViewById(R.id.mensaje);
        mNfcAdapter = NfcAdapter.getDefaultAdapter(this);
        Intent intent = getIntent();
        catalogo_selecionado = intent.getStringExtra(Catalogos.ACTIVIDAD_NFC);
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                params.put("usuario", datosUsuario.getNombre_usuario());
