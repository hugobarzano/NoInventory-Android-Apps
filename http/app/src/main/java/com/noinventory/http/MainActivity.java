    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (networkInfo != null && networkInfo.isConnected()) {
                new GetCommentsTask().
                        execute(
                                new URL("http://192.168.1.35:8000/noinventory/itemsJson/"));
                                System.out.print("Entrando On create");
        ...
        if (id == R.id.action_update) {
            try {
                new GetCommentsTask().
                        execute(
                                new URL("http://192.168.1.35:8000/noinventory/itemsJson/"));
                        System.out.print("(mio)consulta por url de items");
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
        }
